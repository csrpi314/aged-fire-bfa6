...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aged-fire-bfa6
```

A live public deployment of this template is available at [https://aged-fire-bfa6.templates.workers.dev](https://aged-fire-bfa6.templates.workers.dev)
